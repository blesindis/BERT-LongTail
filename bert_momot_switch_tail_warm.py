...
# folder paths
STORE_FOLDER = "wikisst(128)300w-bs64-1epoch-lr3-momot_switch_tail_warm(common-lora, warm-2000, force-0.5, bias-0.3, u-ffn-2, c-full)_layer(6)"
...
def main():
    ...
    model = BertWithMoMoTSwitchTailWarm(config)
