...
from transformer.MoMoTModelRouterMTL import BertWithMoMoTModelRouterMTL, MoMoShareLayer
...
STORE_FOLDER = "wiki(128)300w-bs64-1epoch-lr5-momot_model_router_mtl(lora-full-384, 4-4, att-ogd)_layer(full)_router5000"
