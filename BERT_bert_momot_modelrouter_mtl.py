...
# folder paths
CENTER_MODEL_PATH = "outputs/bert(128)300w-bs64-1epoch-lr1-bert/checkpoint-5000"
CENTER_PATH = os.path.join(CENTER_MODEL_PATH, f'centers-{NUM_EXPERTS}-momoe-transformer-lastlayer.pth')
STORE_FOLDER = "bert(128)300w-bs64-1epoch-lr3-momot_model_router_mtl(same-param, common-lora128)_layer(6)_router5000"
