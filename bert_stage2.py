...
# Local imports
import base_models
from Dataset import ACLForLM, RestaurantForLM, ReviewForLM
...
# folder paths
LOAD_FOLDER = "1127-bert-stage1-8heads-lr1.5"
LOAD_PATH = os.path.join('outputs', LOAD_FOLDER)
STORE_FOLDER = "1128-bert-stage2-review"
...
def main():
    ...
    dataset = ReviewForLM(config, TRAIN_LEN, VAL_LEN)
    ...
    stage1_train_loader, stage1_val_loader = stage1_dataset.train_loader, stage1_dataset.val_loader
    ...
    stage1_train_loader, stage1_val_loader = accelerator.prepare(stage1_train_loader, stage1_val_loader)
    ...
    for epoch in range(num_epochs):
        ...
        for i, batch in enumerate(train_loader):                      
            ...
            if REPLAY:
                for j, batch_r in enumerate(stage1_train_loader):
                    if j == 0:
                        loss_r, _ = model(**batch_r)
