...
from transformer.MoMoTSwitchTail import BertWithMoMoTSwitchTail
...
# folder paths
STORE_FOLDER = "wikisst(128)300w-bs64-1epoch-lr3-momot_switch_tail(common-lora, force-0.5)_layer(other)"
...
def main():
    ...
    model = BertWithMoMoTSwitchTail(config)
