...
# folder paths
STORE_FOLDER = "wikisst(128)300w-bs64-1epoch-lr35-momot_switch_tail_v2(common-lora)_layer(other)(3)"
STORE_PATH = os.path.join('outputs', STORE_FOLDER)
CONFIG_PATH = 'config/tail.json'
...
def main():
    ...
    model = BertWithMoMoTSwitchTailV2(config)
