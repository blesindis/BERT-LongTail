...
CENTER_PATH = os.path.join(CENTER_MODEL_PATH, 'centers-2-attn-token.pth')
STORE_FOLDER = "0109-mot2-useattn-token-NormalAttn-speed"
...
def main():
    ...
    model = base_models.BertWithMoTAttnToken(config, centers)
