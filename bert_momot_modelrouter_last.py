...
CENTER_PATH = os.path.join(CENTER_MODEL_PATH, 'centers-2-momoe-transformer-lastlayer.pth')
STORE_FOLDER = "bert(128)300w-bs64-1epoch-lr3-momot_model_router_last_lora128_normalmoe_drop-prio-cp1.0_layer(10)_router10000"
