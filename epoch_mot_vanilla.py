...
STORE_FOLDER = "0112-mot-vanilla-wiki2(256)"
    ...
    if NEED_CENTER:
        ...
        with torch.no_grad():
            ...
            for i, batch in enumerate(train_loader):
                ...
                for j in range(config.num_hidden_layers-1):
        ...
        for j, layer_output in enumerate(layer_outputs):                 
            _, cluster_centers = cluster_kmeans(layer_output.mean(dim=1), config.num_experts)
