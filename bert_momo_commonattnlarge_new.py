...
# Local imports
import base_models
from Dataset import Wikitext, Wikitext103, MixedPretrain
...
STORE_FOLDER = "0226-momosharecommonattnlarge(new)(TEST)-mix2-bs64-5epoch"
...
def main():
    ...
    model = base_models.BertWithMoMoShareCommonAttnLargeNew(config, centers)
