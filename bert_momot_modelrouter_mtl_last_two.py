...
STORE_FOLDER = "wiki(128)300w-bs64-1epoch-lr3-momot_model_router_mtl(same-param, common-full)_layer(last two)_router5000"
...
def main():
    ...
    model = BertWithMoMoTModelRouterMTLLastTwo(config)
