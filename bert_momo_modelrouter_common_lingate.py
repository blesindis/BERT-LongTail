...
STORE_FOLDER = "bert(128)-bs64-3epoch-lr3-momo_model_router_common_lingate512_router5000"
...
def validate(model, val_loader, accelerator, center_model, config):
...
def main():
    ...
    model = base_models.BertWithMoMoModelRouterCommonLinGate(config, centers)
    ...
    for epoch in range(num_epochs):
        ...
        for i, batch in enumerate(train_loader):    
            ...
            if step % 100 == 0:
                ...
                loss_valid = validate(model, val_loader, accelerator, center_model, config)
