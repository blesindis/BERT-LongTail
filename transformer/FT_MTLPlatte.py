...
from transformer.MoMoTModelRouterMTLPlatte import BertMoMoTModelRouterMTLPlatteModel


class BertMTLPlatteForSequenceClassification(nn.Module):
    ...
    def forward(self, input_ids, attention_mask, labels, cluster_list):
        ...
        outputs = self.bert(input_ids=input_ids, attention_mask=attention_mask, cluster_list=cluster_list)
