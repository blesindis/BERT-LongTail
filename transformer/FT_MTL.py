...
from transformer.MoMoTModelRouterMTL import BertMoMoTModelRouterMTLModel


class BertMTLForSequenceClassification(nn.Module):
    def __init__(self, config, num_labels):
        super().__init__()
        self.config = config
        self.num_labels = num_labels
        self.bert = BertMoMoTModelRouterMTLModel(config)
