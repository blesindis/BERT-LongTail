...
from transformer.modules.feedforward import FeedForward, SwitchFeedForward, SwitchFeedForwardTail
...
class SwitchEncoder(nn.Module):
    def __init__(self, config):
        ...
        self.ffn = SwitchFeedForwardTail(config)
...
class SwitchLastNTailModel(nn.Module):
    def __init__(self, config):
        super(SwitchLastNTailModel, self).__init__()
...
class BertSwitchLastNTail(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.config = config
        self.bert = SwitchLastNTailModel(config)
