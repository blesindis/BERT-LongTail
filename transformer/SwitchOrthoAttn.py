...
from transformer.modules.attention import Attention, OrthoAttention
...
class SwitchEncoder(nn.Module):
    def __init__(self, config):
        ...
        self.attention = OrthoAttention(config)
...
class BertSwitchOrthoAttn(nn.Module):
    def __init__(self, config):
        super(BertSwitchOrthoAttn, self).__init__()
        self.config = config
