...
class SwitchLastTwoModel(nn.Module):
    def __init__(self, config):
        super(SwitchLastTwoModel, self).__init__()
...
class BertSwitchLastTwo(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.config = config
        self.bert = SwitchLastTwoModel(config)
