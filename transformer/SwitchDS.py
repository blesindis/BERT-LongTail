...
from transformer.modules.feedforward import DSFeedForward
...
class SwitchEncoder(nn.Module):
    def __init__(self, config):
        ...
        self.ffn = DSFeedForward(config, lora_dim=128, n_experts=3)
...
class SwitchDSModel(nn.Module):
    def __init__(self, config):
        super(SwitchDSModel, self).__init__()
