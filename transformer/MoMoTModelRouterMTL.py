...
class BertMoMoTModelRouterMTLModel(nn.Module):
    def __init__(self, config):
        super(BertMoMoTModelRouterMTLModel, self).__init__()
...
class BertWithMoMoTModelRouterMTL(nn.Module):
    def __init__(self, config):
        super(BertWithMoMoTModelRouterMTL, self).__init__()
        self.config = config        
