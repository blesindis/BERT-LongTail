...
class BertMoMoTModelRouterMTLPseudoModel(nn.Module):
    def __init__(self, config):
        super(BertMoMoTModelRouterMTLPseudoModel, self).__init__()
...
class BertWithMoMoTModelRouterMTLPseudo(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.config = config        
        self.bert = BertMoMoTModelRouterMTLPseudoModel(config)
