...
from transformer.MoMoTSwitchTailWarm import BertWithMoMoTSwitchTailWarm
...
LOAD_FOLDER = "wikisst(128)300w-bs64-1epoch-lr3-momot_switch_tail_warm(common-lora, warm-2000, force-0.5)_layer(6)/checkpoint-47928"
...
def main():
    ...
    base_model = BertWithMoMoTSwitchTailWarm(config)
    ...
    # print(c)
    losses, h_common, h_tail = get_losses(accelerator, base_model, dataset.val_loader_wiki)
    ...
    plt.legend()
    plt.savefig('Distribution of Common & Tail Wiki .png')
