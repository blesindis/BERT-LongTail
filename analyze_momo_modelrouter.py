...
model_name = 'momoshare'

center_model_path = "bert(128)-bs64-3epoch-lr1-bert"

center_file = 'centers-2-momoe-transformer.pth'

load_folder = "bert(128)-bs64-3epoch-lr3-momo_model_router_common_lora128_router5000"
...
def main():
    ...
    center_path = os.path.join('outputs', center_model_path, 'checkpoint-5000', center_file)
    
    center_model = base_models.BertForMLM(config)
    checkpoint = torch.load(os.path.join('outputs', center_model_path, 'checkpoint-5000', 'pytorch_model.bin'))
