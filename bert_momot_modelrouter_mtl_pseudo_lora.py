...
STORE_FOLDER = "wiki(128)300w-bs64-1epoch-lr3-momot_model_router_mtl_pseudo_lora(lora-u-128, 6-4, warm-5000)_layer(full)_router5000"
...
def main():
    ...
    model = BertWithMoMoTModelRouterMTLPseudoLoRA(config)
