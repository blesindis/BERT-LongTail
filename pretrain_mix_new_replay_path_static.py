...
REPLAY_FILE = 'replay_static.pth'
REPLAY_PATH = os.path.join(LOAD_PATH, REPLAY_FILE)
CONFIG_PATH = 'config/bert.json'

STORE_FOLDER = '1114-mixed-stage2-replay-path-static(1102-mixed-stage1)'
...
def main():
    ...
    if REPLAY:
        replay_static = torch.load(REPLAY_PATH, map_location='cuda') # {index: batch}
