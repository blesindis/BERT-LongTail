...
from transformer.MoMoEncoderGating import BertWithMoMoEncoderGating
...
# folder paths
STORE_FOLDER = "bert(128)300w-bs64-epoch1-lr3-momo_encoder_gating_128(encoder+encoder)"
...
def main():
    ...
    model = BertWithMoMoEncoderGating(config)
