...
from transformer.SwitchOrthoAttn import BertSwitchOrthoAttn
...
# folder paths
STORE_FOLDER = "lepuwiki(128)50w-bs64-epoch1-lr3-moe_ortho_attn(dynamic-matrix)TEST"
...
def main():
    ...
    model = BertSwitchOrthoAttn(config)
