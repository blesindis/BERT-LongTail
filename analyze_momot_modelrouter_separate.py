...
model_name = 'momo_modelrouter-separate'

center_model_path = "bert(128)300w-bs64-1epoch-lr1-bert/checkpoint-10000"

center_file = 'centers-2-momoe-transformer-lastlayer-separate.pth'

load_folder = "bert(128)300w-bs64-1epoch-lr3-momot_model_router_separate_lora128_normalmoe_layer(6)_router10000/checkpoint-45000"
        ...
        for i, batch in enumerate(train_loader):
            ...
            for j in range(config.num_hidden_layers):
                ...
                for c in range(NUM_EXPERTS + 1):
                    outputs_by_cluster.append(model.bert.layers.layers[j].experts[c](hidden_states[cluster_list[c],:,:], batch['attention_mask'][cluster_list[c],:]).to('cpu'))
