...
from transformer.SwitchLastNTail import BertSwitchLastNTail
...
# folder paths
STORE_FOLDER = "wikisst(128)300w-bs64-epoch1-lr3-moe_lastn_tail(6)"
...
def main():
    ...
    model = BertSwitchLastNTail(config)
