...
from transformer.MoMoTModelRouterMTLOther import BertWithMoMoTModelRouterMTLOther
from transformer.BERT import BertForMLM

# Local imports
from Dataset import BERTPretrain, LePuWiki, WikiSST, Wikipedia
...
STORE_FOLDER = "wiki(128)300w-bs64-1epoch-lr3-momot_model_router_mtl(lora-all, 4-4)_layer(other)_router5000"
...
def main():
    ...
    model = BertWithMoMoTModelRouterMTLOther(config)
